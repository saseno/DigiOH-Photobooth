...
async function generateAiImage(data_uri, selectedApi) {
    ...
    try {
        ...
        document.getElementById("results").innerHTML = `<img src="${result.imageUrl}" alt="Result Image" />`;
        document.getElementById("qrcode_viewer").innerHTML = `<img src="${result.qr}" alt="Result Image" />`;
